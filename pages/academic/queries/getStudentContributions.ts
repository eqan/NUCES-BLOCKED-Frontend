...
query GetAllContributions ($FilterContributionsDto: FilterAllContributionDto) {
...
export function returnFetchContributionsHook(contributionType: string, page: number, limit: number){
    const { data, loading, error, refetch } = useQuery(GET_STUDENT_CONTRIBUTIONS, {
        variables: {
