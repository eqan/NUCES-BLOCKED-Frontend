        ...
        <div className="card">
            ...
            <div className="field">
              ...
              <span className="p-input-icon-right">
                <InputText
                  ...
                  autoFocus
                  className={classNames(
                    { 'p-invalid': submitted && !degree.rollno },
                    { 'p-invalid1': submitted && degree.rollno },
                  )}
                />
                {(submitted && !degree.rollno && (
                  <small className="p-invalid">Roll No. is required.</small>
                )) ||
                  (submitted && degree.rollno && !validateRollNo() && (
            ...
            <div className="field">
              ...
              <span className="p-input-icon-right">
                ...
                {submitted && !degree.hash && (
                  <small className="p-invalid">Hash is required.</small>
                )}
          ...
          >
            <div className="flex align-items-center justify-content-center">
              ...
              {degree && (
                <span>
                  Are you sure you want to delete the selected academic
                  certificate
                </span>
              )}
            </div>
