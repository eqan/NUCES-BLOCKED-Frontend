          ...
          <div className="flex justify-content-between align-items-center mb-5">
            ...
            <div>
              <Button
                ...
                onClick={(event) => {
                  if (menu1.current) menu1.current.toggle(event);
                }}
              />
              <Menu
                ref={menu1}
                popup
                model={[{ label: 'Edit Profile', icon: 'pi pi-fw pi-pencil' }]}
              />
            </div>
          </div>
          ...
          <div className="flex align-items-center justify-content-between mb-4">
            ...
            <div>
              <Button
                ...
                className="p-button-rounded p-button-text p-button-plain"
                onClick={(event) => {
                  if (menu2.current) menu2.current.toggle(event);
                }}
              />
              <Menu
                ref={menu2}
                popup
                model={[{ label: 'Delete', icon: 'pi pi-fw pi-minus' }]}
              />
            </div>
          </div>
          ...
          <ul className="p-0 mx-0 mt-0 mb-4 list-none">
            ...
            <li className="flex align-items-center py-2">
              <span className="text-700 line-height-3">
                You have added{' '}
                <span className="text-blue-500 font-medium">20</span> students.
              </span>
            </li>
          </ul>
