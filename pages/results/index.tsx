        ...
        <div className="card">
          ...
          >
            <div className="field">
              ...
              {submitted && !result.semester && (
                <small className="p-invalid">Semester is required.</small>
              )}
            </div>
            <div className="field">
              ...
              <span className="p-input-icon-right">
                <InputText
                  ...
                  autoFocus
                  className={classNames(
                    { 'p-invalid': submitted && !result.year },
                    { 'p-invalid1': submitted && result.year },
                  )}
                />
                {(submitted && !result.year && (
                  <small className="p-invalid">Year is required.</small>
                )) ||
                  (submitted && result.year && !validateYear() && (
                    <small className="p-invalid1">
                      Invalid year, range from 1990 to Current Year
                    </small>
                  ))}
          ...
          >
            <div className="flex align-items-center justify-content-center">
              ...
              {result && (
                <span>
                  Are you sure you want to delete the selected semester result?
                </span>
              )}
            </div>
          </Dialog>
