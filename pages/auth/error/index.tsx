  ...
  return (
    <div className="surface-ground flex align-items-center justify-content-center min-h-screen min-w-screen overflow-hidden">
      <div className="flex flex-column align-items-center justify-content-center">
        <img
          src={`${contextPath}/demo/images/error/logo-error.svg`}
          alt="Sakai logo"
        ...
        <div
          style={{
            ...
            padding: '0.3rem',
            background:
              'linear-gradient(180deg, rgba(233, 1, 99, 0.4) 10%, rgba(33, 150, 243, 0) 30%)',
          }}
        >
          <div
          ...
          >
            ...
            <img
              src={`${contextPath}/demo/images/error/asset-error.svg`}
              alt="Error"
              className="mb-5"
              width="80%"
            />
