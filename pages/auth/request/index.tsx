                ...
                <div style={{ borderRadius: '56px', padding: '0.3rem', background: 'linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 146, 243, 0) 30%)' }}>
                    <div className="w-full surface-card py-8 px-5 sm:px-8" style={{ borderRadius: '53px' }}>
                        <div className="text-center mb-5">
                            ...
                            <span className="text-600 font-medium">The password will be sent to you via email,<br/></span>
                            <span className="text-600 font-medium">After verification.</span>
                        </div>
                        ...
                        <div>
                            ...
                            <InputText type="text" placeholder="Email address" className="w-full md:w-30rem mb-5" style={{ padding: '1rem' }} />

                            <label htmlFor="password1" className="block text-900 font-medium text-xl mb-2">
                                Password
                            </label>
                            
                            <Button label="Request" className="w-full p-3 text-xl" onClick={() => router.push('/auth/login')}></Button>
                        </div>
                    </div>
                </div>
            </div>
