        ...
        >
          ...
          <div className="mx-4 md:mx-8 mt-0 md:mt-4">
            <h1 className="text-6xl font-bold text-gray-900 line-height-2">
              <span className="font-light block">Welcome to</span>NUCES BLOCKED
            </h1>
        ...
        <div id="about" className="py-4 px-4 lg:px-8 my-2 md:my-4">
          <div className="text-center">
            ...
            <span className="text-600 text-2xl">
              NUCES BLOCKED, A platform to empower students after graduating by
              highlighting their Student degree with extracurricular activities
              in an immutable trustworthy system that com- panies and students
              can utilize with minimum effort.
            </span>
          </div>
          ...
          <div className="grid justify-content-between mt-8 md:mt-0">
            <div className="col-12 lg:col-4 p-0 md:p-3">
              <div className="p-3 flex flex-column border-200 pricing-card cursor-pointer border-2 hover:border-primary transition-duration-300 transition-all">
                <h3 className="text-900 text-center my-5">Blockchain</h3>
                <img
                  src={`${contextPath}/demo/images/landing/blockchain.png`}
                ...
                <ul className="my-5 list-none p-0 flex text-900 flex-column">
                  <li className="py-2">
                    ...
                    <span className="text-xl line-height-3">
                      Admin deploys student results and certificates in an
                      immutable ledger on Blockchain.
                    </span>
                  </li>
                </ul>
              </div>
            ...
            <div className="col-12 lg:col-4 p-0 md:p-3 mt-4 md:mt-0">
              <div className="p-3 flex flex-column border-200 pricing-card cursor-pointer border-2 hover:border-primary transition-duration-300 transition-all">
                <h3 className="text-900 text-center my-5">Academic Profile</h3>
                <img
                  src={`${contextPath}/demo/images/landing/academic.png`}
                  className="w-10 h-10 mx-auto"
                  alt="startup"
                />
                ...
                <ul className="my-5 list-none p-0 flex text-900 flex-column">
                  <li className="py-2">
                    <i className=" text-xl text-cyan-500 mr-2"></i>
                    <span className="text-xl line-height-3">
                      Teacher, Society Heads, and Career Counselor mange the
            ...
            <div className="col-12 lg:col-4 p-0 md:p-3 mt-4 md:mt-0">
              <div className="p-3 flex flex-column border-200 pricing-card cursor-pointer border-2 hover:border-primary transition-duration-300 transition-all">
                <h3 className="text-900 text-center my-5">Verification</h3>
                <img
                  src={`${contextPath}/demo/images/landing/correct.png`}
                  className="w-10 h-10 mx-auto"
                  alt="enterprise"
                />
                ...
                <ul className="my-5 list-none p-0 flex text-900 flex-column">
                  <li className="py-2">
                    <i className=" text-xl text-cyan-500 mr-2"></i>
                    <span className="text-xl line-height-3">
                      Company and organization can easily verify student
                      credential using hash.
                    </span>
                  </li>
                </ul>
              </div>
            ...
            <div className="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 lg:pb-5 mt-4 lg:mt-0">
              ...
              >
                ...
                >
                  ...
                  <h5 className="mb-2 text-900">Manage Users</h5>
                  <span className="text-600">
                    Allow the user to manage the profiles of teachers, career
                    counselors, and society heads.
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 lg:pb-5 mt-4 lg:mt-0">
              ...
              >
                ...
                >
                  ...
                  <h5 className="mb-2 text-900">Manage Students</h5>
                  <span className="text-600">
                    Allow the user to manage the student information. This will
                    include adding, removing, and updating student information.
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="col-12 md:col-12 lg:col-4 p-0 lg:pb-5 mt-4 lg:mt-0">
              ...
              >
                ...
                >
                  ...
                  <h5 className="mb-2 text-900">Manage Semester Result</h5>
                  <span className="text-600">
                    Allow the user to manage the semester results of students.
                    This will include adding, removing, uploading, and down-
                    loading results
                  </span>
                </div>
              </div>
            ...
            <div className="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 lg:pb-5 mt-4 lg:mt-0">
              ...
              >
                ...
                >
                  ...
                  <h5 className="mb-2 text-900">Manage Student Degree</h5>
                  <span className="text-600">
                    Allow the user to manage the certificates of students. This
                    will include adding, removing, and uploading certificates.
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 lg:pb-5 mt-4 lg:mt-0">
              ...
              >
                ...
                >
                  ...
                  <h5 className="mb-2 text-900">Manage Academic Profile</h5>
                  <span className="text-600">
                    Allow the user to manage the academic profiles of students.
                    This will include adding, removing, and updating academic
                    profiles.
                  </span>
                </div>
              </div>
...
pi-arrow-down text-2xl text-pink-700"
                  ...
                  <h5 className="mb-2 text-900">Download Student Degree</h5>
                  <span className="text-600">
                    User will be able to download the certificate anytime and
                    anywhere on an internet connection.
                  </span>
                </div>
              </div>
            </div>
