...
import { DegreeMetaDataInfo, StudentMetaDataDetails } from "./DegreeMetaDataInfo";
...
export const Header = ({ heading: studentHeading, metaDataDetails: studentMetaDataDetails }: HeaderProps, ...rest: any ) => (
  <Container {...rest}>
    <MainArea>
