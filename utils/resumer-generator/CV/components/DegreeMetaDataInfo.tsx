...
export const DegreeMetaDataInfo = ({ studentMetaDataDetails }: HeaderProps, style: any) => (
  <Container style={style}>
    <ItemText>
      {selectStyledGlyph("certificate")}{" "}
      <LabelText>Degree Id:</LabelText>{" "}
      <ValueText>{studentMetaDataDetails.degreeId}</ValueText>
    </ItemText>
    <ItemText>
      {selectStyledGlyph("user")}{" "}
