...
const teacherContributions: SubContributions[] = [
    {
        ...
        contribution:
            'Contributed 140 Hours to the project where the individual worked on data modeling to increase accuracy by 40%',
        date: '2023-03-02',
    },
    {
        ...
        contribution:
            'Contributed 150 Hours in teaching, cross checking and evaluating students assignments, quizes and projects.',
        date: '2022-05-03',
    },
]
...
const societyContributions: SubContributions[] = [
    {
        ...
        contribution:
            'Managed 150+ students from all over Pakistan. Lead role in maintaining the technical deficiencies',
        date: '2023-03-02',
    },
    {
        ...
        contribution:
            'As society president held the position for 1 year where he had managed different society teams, organized events.',
        date: '2022-05-03',
    },
]
...
const careerCounsellorContributions: SubContributions[] = [
    {
        ...
        title: 'UGRAD 2023',
        contribution:
            'Under UGRAD attended Missouri State University for the spring semester and represented the Pakistani Culture on global stage.',
        date: '2023-03-02',
    },
    {
        ...
        contribution:
            'As an internee at arbisoft worked with senior software engineer to develop a python and flask backend api to reduce manual data entry by 50%.',
        date: '2022-05-03',
    },
]
